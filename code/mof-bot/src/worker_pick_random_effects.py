...
class Effect:
    def __init__(self, usethird, tag, emojis, emotion, tone, length, lore, scramble, mistakes, thirdperson, sickjoke):
        """
...
def pick_effects():
    ...
    return Effect(usethird=usethird, tag=tag, emojis=emojis, emotion=emotion, tone=tone, length=length, lore=lore, scramble=scramble, mistakes=mistakes, thirdperson=thirdperson, sickjoke=sickjoke)
